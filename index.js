...
// In terminal change directory to day_2 When you see code-intro type: node code-intro
...
// CODE HERE
let faveSnack = "Honey Crisp Apples"
...
console.log(Netflix + Hulu + Disney + YouTubePremium + Peacock)
...
// CODE HERE
Hulu = Hulu - 7 // or Hulu -= 7
Peacock -= 5 // or Peacock = Peacock - 5
Netflix = Netflix -7
...
// CODE HERE
let savings = ((newTotal - total) / total ) * 100
console.log(savings)
